...
- Data loading and quality control of Visium HD samples, including filtering and preprocessing steps
- Standard single-cell workflows adapted for spatial data, including highly variable gene selection, PCA, UMAP, and clustering
- Deconvolution for cell type annotation of spots for sequencing-based technologies with `RCTD`
- Spatial-specific analyses that utilize the physical location of bins/cells on the tissue, including:
   ...
   - Cell-cell communication withh `CellChat`
