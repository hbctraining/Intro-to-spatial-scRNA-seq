...
title: "Integration"
description: |
  Learn how to evaluate whether batch effects are found in your dataset which will inform the decision of whether to integrate or not. Additionally describes the methods behind some common methods for integration.
author:
  - Noor Sohail
date: "2025-07-22"
categories: 
...
We can similarly highlight these bins in on the slide as well:
...
```{r}
#| label: fig-ceacam5
#| fig-cap: CEACAM5 expression shown as violin plot per cluster as well as on the UMAP embedding.
#| fig-width: 10
...
```{r}
#| label: fig-ceacam6
#| fig-cap: CEACAM6 expression shown as violin plot per cluster as well as on the UMAP embedding.
#| fig-width: 10
p_feature <- FeaturePlot(seurat_processed, 
                         features = "CEACAM6",
                         label = TRUE)
