...
description: |
  Use normalization to normalize your spatial transcriptomics data, which is crucial to make comparisons between samples and bins. You will also learn how sketch-based downsampling accelerates exploratory analysis on large  datasets.
author:
  - Noor Sohail
date: "2025-07-22"
categories: 
...
Now that we are on a new step of our analysis, let us create another script titled `02_normalization_and_sketch.R` that will contain our normalization and sketching code. This will help us keep our workflow organized and modular.
