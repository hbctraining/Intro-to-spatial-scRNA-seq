...
The novelty score is computed as a ration of genes to UMIs, as shown below:
...
During sequencing, we do not only measure the levels of expression the nuclear genome - we also the mitochondrial genome! High levels of mitochondrial expression is a sign that the cell is dying or dead. Therefore, we can calculate the proportion of reads (UMIs) that come from the mitochondria out of all the transcripts in a cell as another metric.
