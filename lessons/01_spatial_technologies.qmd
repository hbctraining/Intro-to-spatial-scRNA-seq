...
| **Resolution**       | Subcellular, subdiffraction (seqFISH/seqFISH+) | Subcellular (single‑molecule FISH) | Subcellular, targeted _in situ_ (per‑cell calls with subcellular localization) |
