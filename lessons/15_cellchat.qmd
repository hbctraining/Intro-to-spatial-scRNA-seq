...
We know that cells do not exist in an isolated environment, where they do not interact with anything. To evaluate how different cells are interacting with one another, cell-cell communication analyses will calculate scores of interaction between cell types. Spatial transcriptomics is a great input dataset for these methods because cells are most likely to interact with other cells that are closeby spatially. Identifying these cellular communication networks enhances understanding of differentiation, organ development, and metabolism.


### CellChat

CellChat facilitates the analysis of intercellular interactions and communication networks by providing cell interaction network diagrams and communication pathway analysis. It has expanded its coverage to include 229 signaling pathways, classified into three categories: contact between cells, receptors in the ECM, and signaling via secretion. CellChat emphasizes differential overexpressed ligands and receptors to measure the association between LRPs under the principle of mass action.
