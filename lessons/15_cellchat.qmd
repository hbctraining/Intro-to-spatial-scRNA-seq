...
CellChat is a method that was originally published by [Jin et. al (2021)](https://www.nature.com/articles/s41467-021-21246-9) and then updated several years [Jin et al. (2025)](https://www.nature.com/articles/s41596-024-01045-4) to incorporate spatial coordinates into the model. The output is are lists of significant ligand-receptor interactions between cell types
...
For now, let us say that our biological question is which populations that tumor cells are interacting with from our dataset. So first, we are going to subset the Seurat object to our relevant bins.
